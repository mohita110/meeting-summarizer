...
Supports Anthropic (Claude) or OpenAI as the LLM provider, chosen via
...

{
  ...
  "action_items": [
    {"task": "<what needs to be done>", "owner": "<name or 'Unassigned'>", "due_date": "<date or 'Not specified'>"}
  ]
}

If the transcript has no clear decisions or action items, return empty lists.
"""
...
def _summarize_groq(transcript: str) -> str:
    """
    Uses Groq's free, OpenAI-compatible chat completions endpoint with a Llama model.
